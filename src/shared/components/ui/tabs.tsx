...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-start rounded-lg bg-background border border-border/50 p-1 text-muted-foreground w-full overflow-x-auto",
      className,
    )}
    {...props}
  />
