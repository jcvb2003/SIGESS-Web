...
export function PersonalInfoForm() {
  ...
  useEffect(() => {
    if (alfabetizado === "NÃO") {
      setValue("escolaridade", "ANALFABETO(A)");
    } else if (alfabetizado === "SIM") {
      // Se mudar para SIM e o valor atual for ANALFABETO(A), limpa para escolha explícita
      if (getValues("escolaridade") === "ANALFABETO(A)") {
        setValue("escolaridade", "");
      }
    }
  }, [alfabetizado, setValue, getValues]);
