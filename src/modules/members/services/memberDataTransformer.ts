...
export function toMemberInsertPayload(
  ...
  return {
    ...
    uf_rg: toUpperOrEmpty(input.ufRg),
    ...
    caf: cleanInvisibleCharacters(input.caf) || null,
...
export function fromMemberRecord(
  ...
  return {
    ...
    caf: getString(record.caf),
    rgp: getString(record.num_rgp),
    tipoRgp: (record.tipo_rgp as "INICIAL" | "PROTOCOLO" | "RECADASTRAMENTO" | "NONE") ?? "NONE",
