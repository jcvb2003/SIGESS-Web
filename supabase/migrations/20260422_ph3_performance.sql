-- BE-5: Extensao pg_trgm e indices GIN para busca difusa
-- BE-2: Indice funcional para mes de nascimento

-- 1. Habilitar pg_trgm
CREATE EXTENSION IF NOT EXISTS pg_trgm;

-- 2. Indices GIN para busca difusa (trigram)
...
-- 3. Indice funcional para mes de nascimento (BE-2)
-- Isso otimiza o filtro de "Aniversariantes do Mes"
...
-- Atualmente filtrado em JS, o que e ineficiente para muitos socios.
