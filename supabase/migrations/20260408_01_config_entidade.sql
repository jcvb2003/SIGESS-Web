...
-- Objetivo: Criar tabela de configuracao global e remover max_socios de User.
-- =============================================================================

-- 1. Criar a nova tabela de configuracao
...
-- 3. Atualizar a Trigger de Limite de Socios
-- Saneamento: Remover a funcao antiga que lia de public."User"
...
BEGIN
    ...
    IF v_current_count >= v_max_socios THEN
        RAISE EXCEPTION 'Limite de socios atingido (%)', v_max_socios;
    END IF;
...
-- Nota: Fazemos isso por ultimo para garantir que os dados legados nao influenciem mais.
